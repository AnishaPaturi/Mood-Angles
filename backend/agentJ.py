...
Task:
Task:
1) Give a short diagnostic decision label in plain language (one of: "Likely", "Possible", or "Unlikely"). Do NOT use "Insufficient evidence" under any circumstances.
...
- JSON keys must be: decision, confidence, reasoning, actions, final_call (actions is an array).
