...
//     try {
//       // ---------- Agent R ----------
//       const payloadR = { score, level, answers: buildAnswersPayload() };
...
//       finalSummary = String(data.result || "").trim();
...
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ agentR_result: finalSummary, score, level }),
//       });
...
//       // allow both cData.result or cData.Result etc.
//       const cSummary = cData.result || cData.Result || String(cData).trim();
...
//           condition: "Bipolar Disorder", // adjust dynamically if you add multiple tests
//         }),
//       });
...
//           // store the parsed object (decision/confidence/reasoning/actions) or fallback string
...
//       // show the error for debugging and preserve earlier partial results
//       setResult((prev) => ({
//         ...prev,
